    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <main className="relative flex min-h-[calc(100vh-48px)] items-center justify-center overflow-hidden px-4">
                <HandshakeIllustration className="pointer-events-none absolute bottom-6 left-6 hidden h-auto w-56 lg:block" />
                <ChecklistIllustration className="pointer-events-none absolute bottom-6 right-6 hidden h-auto w-56 lg:block" />
