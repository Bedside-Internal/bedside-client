...
export default function StationError({
    ...
    useEffect(() => {
        console.error("MMI station failed to load:", error);
    }, [error]);

    return (
        <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[var(--color-cream)] px-6 text-center">
            <p className="text-lg font-semibold text-[var(--color-ink)]">
                This station couldn&apos;t load
            </p>
            <p className="max-w-sm text-sm text-[var(--color-ink)]/60">
                That might be a hiccup with your session or the network. Try
                again, or head back and pick a different station.
            </p>
